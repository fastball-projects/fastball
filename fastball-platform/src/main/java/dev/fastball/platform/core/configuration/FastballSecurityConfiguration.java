...
import dev.fastball.platform.core.security.filter.JwtAuthenticationFilter;
import dev.fastball.platform.core.security.filter.PasswordAuthenticationFilter;
...
import dev.fastball.platform.core.security.handler.UnloginAuthenticationEntryPoint;
import dev.fastball.platform.core.security.matcher.DynamicAnonymousPathRequestMatcher;
import dev.fastball.platform.core.security.service.DefaultUserDetailsService;
...
public class FastballSecurityConfiguration {
    ...
    @Bean
    public UserDetailsService fastballUserDetailsService(FastballPortalService fastballPlatformService) {
