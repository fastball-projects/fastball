...
@Repository
public interface PermissionRepo extends JpaRepository<JpaPermissionEntity, String> {
    ...
    List<JpaPermissionEntity> findByUserId(String userId);
    ...
    List<JpaPermissionEntity> findByUserIdAndType(String userId, String permissionType);
}
